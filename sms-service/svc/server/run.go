...
func NewEndpoints(service pb.SmsServer) svc.Endpoints {
	// Business domain.
	...
	// Endpoint domain.
	var (
		sendsmsEndpoint = svc.MakeSendSmsEndpoint(service)
	)
