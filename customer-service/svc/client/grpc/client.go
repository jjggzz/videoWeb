...
func New(conn *grpc.ClientConn, clientOptions []grpctransport.ClientOption, options ...ClientOption) (pb.CustomerServer, error) {
	...
	var selectcustomerEndpoint endpoint.Endpoint
	{
		selectcustomerEndpoint = grpctransport.NewClient(
			conn,
			"proto.Customer",
			"SelectCustomer",
			EncodeGRPCSelectCustomerRequest,
			DecodeGRPCSelectCustomerResponse,
			pb.Empty{},
			clientOptions...,
		).Endpoint()
	}
	...
	return svc.Endpoints{
		...
		SelectCustomerEndpoint:  selectcustomerEndpoint,
	}, nil
}
...
// DecodeGRPCSelectCustomerResponse is a transport/grpc.DecodeResponseFunc that converts a
// gRPC selectcustomer reply to a user-domain selectcustomer response. Primarily useful in a client.
func DecodeGRPCSelectCustomerResponse(_ context.Context, grpcReply interface{}) (interface{}, error) {
...
// EncodeGRPCSelectCustomerRequest is a transport/grpc.EncodeRequestFunc that converts a
// user-domain selectcustomer request to a gRPC selectcustomer request. Primarily useful in a client.
func EncodeGRPCSelectCustomerRequest(_ context.Context, request interface{}) (interface{}, error) {
